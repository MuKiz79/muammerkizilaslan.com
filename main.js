...
function renderCase(key){
  ...
  caseDialog.style.setProperty('--case-color',{hans:'#285c63',bor:'#c7a04a',bsh:'#ced2cf'}[key]);
  caseDialog.style.setProperty('--case-ink',{hans:'#f7f5ed',bor:'#2d291f',bsh:'#293331'}[key]);
