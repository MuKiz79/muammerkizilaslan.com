...
(function(root){
  ...
  const products={
    presence:{image:'images/karriaro-webdesign-current.png',imageAlt:'Aktuelle Karriaro-Webdesign-Startseite: Websites mit Persönlichkeit',imageCaption:'Karriaro-Webdesign · Aktuelle Website',name:'Karriaro-Webdesign',status:'Live',number:'01',reason:'Sie möchten als Unternehmen sichtbar werden. Hier gestalte und entwickle ich individuelle Websites und Onlineshops.',url:'https://karriaro-webdesign.de/',cta:'Webdesign entdecken',tags:['Website','Sichtbarkeit','KI-Werkzeuge']},
